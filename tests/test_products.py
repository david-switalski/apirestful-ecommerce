...
class TestAdminProductActions:
    ...
    async def test_admin_can_create_product(self, authenticated_admin_client: AsyncClient, db_session: AsyncSession, product_data: dict):
    ...
    async def test_normal_user_cannot_create_product(self, authenticated_user_client: AsyncClient, product_data: dict):
    ...
    async def test_admin_can_update_product(self, authenticated_admin_client: AsyncClient, created_product: ProductModel, db_session: AsyncSession):
    ...
    async def test_admin_can_delete_product(self, authenticated_admin_client: AsyncClient, created_product: ProductModel, db_session: AsyncSession):
...
class TestProductCaching:
    ...
    async def test_read_product_populates_cache(self, client: AsyncClient, created_product: ProductModel, test_redis_client: Redis):
    ...
    async def test_read_product_hits_cache(self, client: AsyncClient, created_product: ProductModel, test_redis_client: Redis):
        ...
        await test_redis_client.set(cache_key, json.dumps(cached_dummy_data, default=str))
    ...
    async def test_update_product_invalidates_cache(self, authenticated_admin_client: AsyncClient, created_product: ProductModel, test_redis_client: Redis):
        ...
        await authenticated_admin_client.patch(f"/products/{product_id}", json=update_data)

        assert await test_redis_client.get(cache_key) is None

    async def test_delete_product_invalidates_cache(self, authenticated_admin_client: AsyncClient, created_product: ProductModel, test_redis_client: Redis):
