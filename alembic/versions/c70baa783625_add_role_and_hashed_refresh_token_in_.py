...
def upgrade() -> None:
    ...
    op.add_column('user', sa.Column('role', sa.Enum('admin', 'user', name='user_role_enum'), nullable=False))
    op.add_column('user', sa.Column('hashed_refresh_token', sa.String(length=512), nullable=True))
