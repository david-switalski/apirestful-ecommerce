...
class UserHasOrdersError(Exception):
    ...
    def __init__(self, username: str):
        self.username = username
        super().__init__(f"Cannot delete user '{username}' because they have existing orders.")
...
class ProductInUseError(Exception):
    ...
    def __init__(self, product_name: str):
        ...
        super().__init__(f"Cannot delete product '{product_name}' because it is part of an existing order.")
...
class ProductUnavailableError(Exception):
    ...
    def __init__(self, product_name: str):
        self.product_name = product_name
        super().__init__(f"Product '{product_name}' is currently unavailable for purchase.")
...
class InsufficientStock(Exception):
    ...
    def __init__(self, product_id: int, product_name: str, requested: int, available: int):
        self.product_id = product_id
        self.product_name = product_name
...
class EmptyOrder(Exception):
    ...
    def __init__(self, message="Cannot create an order with no items."):
